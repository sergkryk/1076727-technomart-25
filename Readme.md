...
* Студент: [Сергей Крюков](https://up.htmlacademy.ru/htmlcss/25/user/1076727).
* Наставник: [Виктор Кан].
<!-- добавляю комментарии и делаю комиты из терминала -->
---
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1076727-technomart-25) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
